...
class Selfie_Core
{
    ...
    public function addSelfieStyling() {
        ...
        if(trim($config->message_prefix) !== '')
        {
            ...
            . " .selfie-sidebar-box { border: 8px solid #222; padding: 20px; background-color: #fff;}"
            . " .selfie-tip { width: 0px; height: 0px; border-top: 0px solid transparent; border-bottom: 20px solid transparent; border-left: 20px solid black; display: inline-block; position: relative; left: 80%;}"
            . " .selfie-tip.left { border-left: none; border-right: 20px solid black; display: inline-block; position: relative; left: 20%;}"
            . " .selfie-sidebar-container { margin-bottom: 7px; }"
            . "</style>";            
        }        
    }
