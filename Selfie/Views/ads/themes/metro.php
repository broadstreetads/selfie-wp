<div <?php if(isset($modal) && $modal) echo 'data-selfie-modal="true"'; ?> class="selfie-div selfie-metro">
    ...
    <div class="selfie-footer">
        ...
        <?php if($config->show_help): ?>
            <a class="selfie-metro-help-link" target="_blank" href="<?php echo get_bloginfo('wpurl') .'/'. Selfie_Core::SELFIE_ABOUT_SLUG ?>/">What is this?</a>
        <?php endif; ?>
