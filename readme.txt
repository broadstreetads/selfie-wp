...
1. **Selfie in a Post** - This is selfie being rendered in a post. The style is customizable.
2. **Selfie Options Page** - You have a wide range of controls over pricing and styling.
3. **Selfie How-To** - A plugin is only as good as its tutorial, if needed. Ours covers everything.

== Installation ==

1. Install and activate the plugin
2. A new admin menu will appear on the left named "Selfie"
3. Click and read Selfie -> "How to Get Started"
